/*************************************************************************
 * File Name: malloc_track/slub_track.c
 * Author: zhangkui
 * Mail: 
 * Created Time: Fri 12 Jun 2020 04:08:08 PM CST
 ************************************************************************/
#ifndef _SLUB_TRACK_
#define _SLUB_TRACK_
...
/* Kui.Zhang@BSP.Kernel.MM, 2020-02-13, sort the locations with count from
 * more to less.
 */
...
/* Kui.Zhang@BSP.Kernel.MM, 2020-02-13, kmalloc_debug_info add debug to
 * slab name.
 */
...
/* Kui.Zhang@BSP.Kernel.MM, 2020-02-13, kmalloc_debug_caches store the
 * kmalloc caches with debug flag.
 */
atomic64_t kmalloc_debug_caches[KMALLOC_RECLAIM+1][KMALLOC_SHIFT_HIGH + 1] = {{ATOMIC64_INIT(0)}};
...
/* Kui.Zhang@BSP.Kernel.MM, 2020-02-13, new api */
...
/* Kui.Zhang@BSP.Kernel.MM, 2020-02-13, add new proc interface for create
