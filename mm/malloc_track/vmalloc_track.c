...
/* Kui.Zhang@BSP.Kernel.MM, 2020-02-26, remember the vmalloc info. */
...
/* Kui.Zhang@BSP.Kernel.MM, 2020-02-26, save vmalloc stack. */
...
/* Kui.Zhang@BSP.Kernel.MM, 2020-02-26, implement vmalloc_debug proc file
 * operations. */
typedef struct {
	const void *caller;
	unsigned int hash;
