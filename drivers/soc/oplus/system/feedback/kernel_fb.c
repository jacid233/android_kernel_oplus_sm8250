...
static char *const _tag[FB_MAX + 1] = {
	"fb_stability",
	"fb_fs",
	"fb_storage",
	"fb_sensor",
...
static unsigned int fb_event_id[FB_MAX + 1] = {
	0,
	0,
	0,
	710,
	...
	fb_tag tag_id, const char *event_id, unsigned char *payload)
{
	...
	if (tag_id > FB_MAX || !event_id || !payload || !_tag[tag_id]) {
		return NULL;
        }
