...
extern int oppo_press_cali_data_init(void);
extern void oppo_press_cali_data_clean(void);
    ...
    size_t count, loff_t *off)
{
    ...
    len = sprintf(page, "%d", g_chip->s_vector[OPPO_LIGHT].hw[0].feature.feature[0]);
...
static int oppo_als_cali_data_init()
{
    int rc = 0;
...
static int oppo_devinfo_probe(struct platform_device *pdev)
{
    ...
    oppo_press_cali_data_init();
    rc = oppo_als_cali_data_init();
