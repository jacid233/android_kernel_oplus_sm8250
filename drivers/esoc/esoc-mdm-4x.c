...
#ifdef VENDOR_EDIT
//Weidong.Chen@PSW.NW.RF, 2019/12/14, Add for return char count
...
static void mdm_get_restart_reason(struct work_struct *work)
{
	int ret, ntries = 0;
    #ifdef VENDOR_EDIT
    //Weidong.Chen@PSW.NW.RF, 2019/12/14, Add for customized subsystem ramdump return reason
	char mdmflag = ':';
	int mdmnum;
	int mdmret1,mdmret2,mdmret3=0;
