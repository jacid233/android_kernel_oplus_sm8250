...
#Zhou.HanSheng@CONNECTIVITY.WIFI.CONNECT.SCAN.343551, 2020/09/09,
#7250R upgrade project does not adjust RSSI.
ifneq ($(BOARD_PLATFORM),lito)
  cppflags-y += -DOPLUS_ADJUST_RSSI
endif
