...
//#include "../slave_charger/oppo_bq25601d.h"
...
aicl_pre_step:		
	...
	/*if (g_oppo_chip->dual_charger_support && g_oppo_chip->slave_charger_enable) {
		...
		g_oppo_chip->chg_ops->slave_input_current_write(usb_icl[i] * 1000 * g_oppo_chip->slave_pct / 100);
