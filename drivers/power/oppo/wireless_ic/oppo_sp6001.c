...
#include "../charger_ic/oppo_chargepump.h"
#include <oppo_sp6001.h>

int send_msg_timer = 0;
int send_step_timer = 0;

struct oppo_sp6001_ic *sp6001_chip = NULL;

static DEFINE_MUTEX(sp6001_i2c_access);

#define SP6001_ADD_COUNT      2
static int __sp6001_read_reg(struct oppo_sp6001_ic *chip, int reg, char *returnData, int count)
{
...
static int __sp6001_write_reg(struct oppo_sp6001_ic *chip, int reg, int val)
{
	int ret;
...
static int sp6001_read_reg(struct oppo_sp6001_ic *chip, int reg, char *returnData, int count)
{
	int ret = 0;
...
static int sp6001_write_reg(struct oppo_sp6001_ic *chip, int reg, int val)
{
	int ret = 0;
...
static int sp6001_config_interface (struct oppo_sp6001_ic *chip, int RegNum, int val, int MASK)
{
	char sp6001_reg = 0;
	int ret = 0;
...
void sp600_send_msg_ask_idt_pack1(struct oppo_sp6001_ic *chip)
{
...
void sp600_send_msg_ask_idt_pack2(struct oppo_sp6001_ic *chip)
{
...
void sp600_send_msg_ask_idt_pack3(struct oppo_sp6001_ic *chip)
{
...
void sp600_send_msg_ask_adapter_type(struct oppo_sp6001_ic *chip)
{
...
void sp600_send_msg_enter_fastchg_mode(struct oppo_sp6001_ic *chip)
{
...
void sp600_send_msg_enter_usb_mode(struct oppo_sp6001_ic *chip)
{  
...
void sp600_send_msg_enter_normal_mode(struct oppo_sp6001_ic *chip)
{ 
...
static void p922x_set_rx_charge_voltage(struct oppo_sp6001_ic *chip, int vol)
{
...
int sp6001_get_vrect_iout(struct oppo_sp6001_ic * chip)
{
	char vrect_value = 0;
	char vout_value = 0;
	char iout_value = 0;
...
static int p922x_detect_CEP(struct oppo_sp6001_ic * chip)
{
	int rc = -1;
	char temp = 0;
...
static int p922x_RXTX_message_process(struct oppo_sp6001_ic *chip)
{
#ifdef WPC_USE_SP6001
	if (send_msg_timer < 5) {
		send_msg_timer++;
...
static int sp6001_driver_probe(struct i2c_client *client, const struct i2c_device_id *id) 
{
	...
	chip = devm_kzalloc(&client->dev,
		sizeof(struct oppo_sp6001_ic), GFP_KERNEL);
	if (!chip) {
...
static const struct of_device_id sp6001_match[] = {
	{ .compatible = "oppo,sp6001-charger"},
	{ },
};
