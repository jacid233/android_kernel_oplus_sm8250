...
extern void futex_dynamic_ux_enqueue_refs(struct task_struct *owner, struct task_struct *task);
extern void futex_dynamic_ux_dequeue_refs(struct task_struct *task, int value);
#endif
