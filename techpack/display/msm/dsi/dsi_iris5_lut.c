...
#ifdef VENDOR_EDIT
/*Ling.Guo@PSW.MM.Display.LCD.Log,2020-03-23 add keylog */
...
#ifdef VENDOR_EDIT
/*Ling.Guo@PSW.MM.Display.LCD.Log,2020-03-23 add keylog */
	if (pcfg && pcfg->lightup_no_fw && (MSM_BOOT_MODE__NORMAL == get_boot_mode())) {
		scnprintf(payload, sizeof(payload), "NULL$$EventID@@%d$$LIGHTUP_NO_FW",OPPO_MM_DIRVER_FB_EVENT_ID_ESD);
