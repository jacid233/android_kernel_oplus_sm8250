		...
		if ((q6core_get_avcs_api_version_per_service(
			...
			if (((this_adm.ec_ref_rx & AFE_PORT_INVALID) !=
				...
				if (this_adm.num_ec_ref_rx_chans != 0) {
					...
					#ifdef VENDOR_EDIT
					/* Ming.Liu@PSW.MM.AudioDriver.Codec, 2020/03/18, Modified for debug */
					pr_err("%s: this_adm.ec_ref_rx = %#x, port_id = %#x, topology = %#x, acdb_id = %d, copp_idx = %d\n",
						__func__, this_adm.ec_ref_rx, port_id, topology, acdb_id, copp_idx);
					#endif
