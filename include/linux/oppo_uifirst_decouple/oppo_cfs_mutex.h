...
static inline void mutex_list_add(struct task_struct *task, struct list_head *entry, struct list_head *head, struct mutex *lock)
{
}
static inline void mutex_dynamic_ux_enqueue(struct mutex *lock, struct task_struct *task)
{
}
static inline void mutex_dynamic_ux_dequeue(struct mutex *lock, struct task_struct *task)
{
}
