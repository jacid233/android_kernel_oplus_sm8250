...
int upload_mm_fb_kevent_to_atlas(unsigned int event_id, unsigned char *payload);
...
int upload_mm_fb_kevent_fb_to_atlas_limit(unsigned int event_id, unsigned char *payload, int limit_ms) {return 0;}
int upload_mm_fb_kevent_fb_to_atlas(unsigned int event_id, unsigned char *payload) {return 0;}
int upload_mm_fb_kevent_limit(enum OPLUS_MM_DIRVER_FB_EVENT_MODULE module,  unsigned int event_id, \
			 const char *name, int rate_limit_ms, char *payload) {return 0;}
...
int mm_fb_kevent_init(void) {return 0;}
void mm_fb_kevent_deinit(void) {}
