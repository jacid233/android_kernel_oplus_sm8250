...
#undef TRACE_SYSTEM
#define TRACE_INCLUDE_PATH ../../block/oppo_uxio_first/trace
#define TRACE_SYSTEM uxio_first_opt_trace

#if !defined(_OPPO_UXIO_FIRST_OPT_TRACE_H) || defined(TRACE_HEADER_MULTI_READ)
#define _OPPO_UXIO_FIRST_OPT_TRACE_H
